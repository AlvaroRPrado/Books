...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AnimatedLibraryAccessors extends SubDependencyFactory {
        private final AnimatedSvgLibraryAccessors laccForAnimatedSvgLibraryAccessors = new AnimatedSvgLibraryAccessors(owner);

        public AnimatedLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>animated.svg</b>
         */
        public AnimatedSvgLibraryAccessors getSvg() {
            return laccForAnimatedSvgLibraryAccessors;
        }

    }

    public static class AnimatedSvgLibraryAccessors extends SubDependencyFactory {

        public AnimatedSvgLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>view</b> with <b>com.jaredrummler:animated-svg-view</b> coordinates and
         * with version reference <b>animatedSvgView</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getView() {
            return create("animated.svg.view");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>animatedSvgView</b> with value <b>1.0.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getAnimatedSvgView() { return getVersion("animatedSvgView"); }
        ...
        /**
         * Version alias <b>navigationUiKtx</b> with value <b>2.7.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
